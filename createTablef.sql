spool &data_dir.part1c.txt
Set Echo on
Set Verify on

REM DROPPING TABLES FROM THE DATABASE
...
CREATE TABLE BRANCH(
    ...
    STAFF_ID CHAR(3) CONSTRAINT STAFF_FK_BRANCH REFERENCES STAFF(STAFF_ID));
...
CREATE TABLE PROPERTY(
    ...
    REGISTERED DATE,
    PROP_TYPE CHAR(1)
        CONSTRAINT PROP_RorS CHECK (PROP_TYPE IN ('R','S')),
    LANDLORD_ID CHAR(3),
...
CREATE TABLE PROPERTY_DESC(
    PROP_ID CHAR(3) CONSTRAINT PROP_DSC REFERENCES PROPERTY(PROP_ID),
    PROPDESC_ID CHAR(3),
...
CREATE TABLE ARRANGED_VIEWING_BY(
    PROP_ID CHAR(3) CONSTRAINT PROP_AVB REFERENCES PROPERTY(PROP_ID),
    CUSTOMER_ID CHAR(3) CONSTRAINT BUYER_AVB REFERENCES CUSTOMER (CUSTOMER_ID),
    BRANCH_ID CHAR(3)
...
CREATE TABLE PROP_RENTED(
    PROP_ID CHAR(3) CONSTRAINT PROP_RFK REFERENCES PROPERTY(PROP_ID),
    TENANT_ID CHAR(3),
...
CREATE TABLE PROP_SOLD(
    PROP_ID CHAR(3) CONSTRAINT PROP_SFK REFERENCES PROPERTY(PROP_ID),
    BUYER_ID CHAR(3) CONSTRAINT BUYER_SFK REFERENCES CUSTOMER (CUSTOMER_ID),
...
CREATE TABLE S_CONTACT(
    ...
    S_CONTACT_ID CHAR(3), CONSTRAINT S_CONTACT_KEY PRIMARY KEY (S_CONTACT_ID),
    S_TEL_NUMBER CHAR(11) CONSTRAINT S_PHONE CHECK(REGEXP_LIKE(S_TEL_NUMBER, '[0-9]{11}')) UNIQUE,
    S_EMAIL VARCHAR(30) CONSTRAINT S_CHK_EMAIL CHECK(REGEXP_LIKE(S_EMAIL, '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$')) UNIQUE );

CREATE TABLE C_CONTACT(
    CUSTOMER_ID CHAR(3),
        CONSTRAINT CUSTOMER_C_FK FOREIGN KEY(CUSTOMER_ID) REFERENCES CUSTOMER(CUSTOMER_ID),
    C_CONTACT_ID CHAR(3), CONSTRAINT C_CONTACT_KEY PRIMARY KEY (C_CONTACT_ID),
    C_TEL_NUMBER CHAR(11) CONSTRAINT C_PHONE CHECK(REGEXP_LIKE(C_TEL_NUMBER, '[0-9]{11}')) UNIQUE,
    C_EMAIL VARCHAR(30) CONSTRAINT C_CHK_EMAIL CHECK(REGEXP_LIKE(C_EMAIL, '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$')) UNIQUE);

CREATE TABLE B_CONTACT(
    BRANCH_ID CHAR(3),
        CONSTRAINT BRANCH_C_FK FOREIGN KEY(BRANCH_ID) REFERENCES BRANCH(BRANCH_ID),
    B_CONTACT_ID CHAR(3), CONSTRAINT B_CONTACT_KEY PRIMARY KEY (B_CONTACT_ID),
    B_TEL_NUMBER CHAR(11) CONSTRAINT B_PHONE CHECK(REGEXP_LIKE(B_TEL_NUMBER, '[0-9]{11}')) UNIQUE,
    B_EMAIL VARCHAR(30) CONSTRAINT B_CHK_EMAIL CHECK(REGEXP_LIKE(B_EMAIL, '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$')) UNIQUE);

CREATE TABLE STAFF_ADDRESS(
    STAFF_ID CHAR(3),
        CONSTRAINT STAFF_A_FK FOREIGN KEY(STAFF_ID) REFERENCES STAFF(STAFF_ID),
    S_ADDRESS_ID CHAR(3) CONSTRAINT S_ADDRESS_KEY PRIMARY KEY,
    SUBURB VARCHAR(20),
    CITY VARCHAR(20),
    POSTCODE VARCHAR(7) );
...
CREATE TABLE CUSTOMER_ADDRESS(
    ...
    C_ADDRESC_ID CHAR(3) CONSTRAINT C_ADDRESC_KEY PRIMARY KEY,
    SUBURB VARCHAR(20),
    CITY VARCHAR(20),
    POSTCODE VARCHAR(7) );
...
CREATE TABLE BRANCH_ADDRESS(
    ...
    B_ADDRESB_ID CHAR(3) CONSTRAINT B_ADDRESB_KEY PRIMARY KEY,
    SUBURB VARCHAR(20),
    CITY VARCHAR(20),
    POSTCODE VARCHAR(7) );
...
CREATE TABLE PROPERTY_ADDRESS(
    ...
    P_ADDRESP_ID CHAR(3) CONSTRAINT P_ADDRESP_KEY PRIMARY KEY,
    SUBURB VARCHAR(20),
    CITY VARCHAR(20),
    POSTCODE VARCHAR(7) );
